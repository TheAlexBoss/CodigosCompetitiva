...
class MaxFlow
{
    ...
    public static void main (String[] args) throws java.lang.Exception
    {
        ...
        System.out.println("The maximum possible flow is " +
                bipartiteMatching(graph, 0, 5));

    }

    public static boolean findMatch(int[][] graph, int u, boolean[] seen, int matchR[], int N){
        for (int v = 0; v < N; v++) {
    ...
    public static int bipartiteMatching(int[][] graph, int N, int M){
